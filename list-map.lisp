...
(defmacro! with-multi-map (map &body body)
  `(labels ((,(symb map '-get) (,g!key) (f ,map :get ,g!key))
			(,(symb map '-add) (,g!key ,g!value) (f ,map :add ,g!key ,g!value))
			(,(symb map '-add-all) (,g!key ,g!values) (f ,map :add-all ,g!key ,g!values))
			(,(symb map '-map) () (f ,map :map)) )


	 (symbol-macrolet ((,(symb map '-size) (f ,map :size)))
					  ,@body)))
